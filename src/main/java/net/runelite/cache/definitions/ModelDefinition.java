...
public class ModelDefinition
{
	...
	public void computeAnimationTables()
	{
		if (this.packedVertexGroups != null)
		{
			...
			// NOTE: RuneLite clears packedVertexGroups here to save memory. The editor's animation
			// path (AnimationManager.pose) detects animatable models by packedVertexGroups != null
			// and rebuilds the tables on a clone, so we must KEEP it — otherwise every model looks
			// static and nothing animates.
		}
